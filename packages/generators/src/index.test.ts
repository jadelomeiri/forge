...
test('generateScaffold writes controller, views, routes metadata, tests, and manifest entries', async () => {
  ...
  assert.equal(await readFile(path.join(projectRoot, 'app/views/posts/index.html'), 'utf8'), renderScaffoldIndexView({
    modelName: 'Post',
    collectionPath: 'posts',
    controllerClassName: 'PostsController',
    controllerFileName: 'posts',
  ...
  assert.equal(await readFile(path.join(projectRoot, 'app/views/posts/_form.html'), 'utf8'), renderScaffoldFormPartial({
    modelName: 'Post',
    collectionPath: 'posts',
    controllerClassName: 'PostsController',
    controllerFileName: 'posts',
